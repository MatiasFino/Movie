    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `MovieEntity` (`categories` TEXT NOT NULL, `adult` INTEGER NOT NULL, `backdrop` TEXT NOT NULL, `genres` TEXT NOT NULL, `id` INTEGER NOT NULL, `originalLanguage` TEXT NOT NULL, `originalTitle` TEXT NOT NULL, `overview` TEXT NOT NULL, `popularity` REAL NOT NULL, `poster` TEXT NOT NULL, `releaseDate` TEXT NOT NULL, `title` TEXT NOT NULL, `video` INTEGER NOT NULL, `voteAverage` REAL NOT NULL, `voteCount` INTEGER NOT NULL, `likes` INTEGER NOT NULL, PRIMARY KEY (`id`))');
...
class _$MovieDao extends MovieDao {
  ...
  Stream<MovieEntity?> findMoviesByCategory(String category) {
    return _queryAdapter.queryStream('SELECT * FROM Movie WHERE category = ?1',
        mapper: (Map<String, Object?> row) => MovieEntity(
            adult: (row['adult'] as int) != 0,
            backdrop: row['backdrop'] as String,
            genres: _intListConverter.decode(row['genres'] as String),
...
final _endPointListConverter = EndPointListConverter();
